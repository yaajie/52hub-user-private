...
const hubs = [
  ...
  { to: '/tools', code: 'TLS', icon: WrenchScrewdriverIcon, accent: 'var(--ui-accent)', accentSoft: 'color-mix(in srgb, var(--ui-accent) 16%, transparent)', title: '在线工具', desc: 'AI IP 环境检测、Codex Auth、服务状态与 DNS 隐私检测。' },
  { to: '/blog', code: 'EDU', icon: BookOpenIcon, accent: '#4285F4', accentSoft: 'rgba(66, 133, 244, 0.16)', title: 'AI 资讯 & 教程', desc: 'Claude / ChatGPT / Codex 的最新资讯与选购、注册、防封排错实战笔记。' },
] satisfies HubCard[]
</script>
