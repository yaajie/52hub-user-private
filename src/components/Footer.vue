    ...
    <div class="container mx-auto px-4 py-16 relative">
      <div class="grid grid-cols-2 md:grid-cols-5 gap-8 md:gap-12 mb-16">
        ...
        <div class="col-span-2 space-y-6">
          ...
          <div>
            <h4 class="theme-text-primary font-bold mb-4 tracking-wide">{{ t('footer.contact') }}</h4>
            <div class="space-y-2.5 text-sm">
              <a :href="telegramServiceUrl" target="_blank"
                rel="noopener noreferrer"
                class="inline-flex items-center gap-2 theme-link-muted hover:theme-text-primary transition-colors">
                ...
                <span>Telegram 客服 @HUB52service</span>
              </a>
              <br />
              <a :href="CONTACTS.telegramChannel" target="_blank"
                rel="noopener noreferrer"
                class="inline-flex items-center gap-2 theme-link-muted hover:theme-text-primary transition-colors">
                <svg class="w-4 h-4 text-cyan-500 shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  <path
                    d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.64-.203-.658-.64.135-.954l11.566-4.458c.538-.196 1.006.128.832.941z" />
                </svg>
                <span>Telegram 频道 @Hub52Notice</span>
              </a>
              <br />
              <router-link to="/notice/announcement-channel"
                class="inline-flex items-center gap-2 theme-link-muted hover:theme-text-primary transition-colors">
                <IconQQ class="w-4 h-4 text-[#1AB6FF] shrink-0" />
                <span>QQ 群 1105879333（密码 52hub）</span>
              </router-link>
              <br v-if="config?.contact?.whatsapp" />
