  ...
  <div class="self-start h-fit p-4 md:p-6 lg:p-8 theme-surface-soft border-b lg:border-b-0 lg:border-r theme-border">
    <div class="mb-4 md:mb-5 relative group"
      ...
      <img v-if="currentImage" :src="currentImage" :alt="productTitle"
        fetchpriority="high"
        decoding="async"
        class="w-full aspect-[5/4] object-cover rounded-xl border theme-border relative z-10 shadow-lg" />
      <div v-else
        class="w-full aspect-[5/4] theme-surface-muted rounded-xl border theme-border flex items-center justify-center relative z-10">
