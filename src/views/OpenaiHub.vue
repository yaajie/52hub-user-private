...
const sections = [
  ...
  },
  {
    title: '客户端 & 工具',
    items: [
      { name: 'AI IP 环境检测', url: '/tools/ip', desc: '登录、订阅或调用前先检测当前出口是否适合 ChatGPT' },
...
const faq = [
  ...
  },
  {
    ...
    a: 'Plus（$20/月）日常聊天写作够用；Pro 5x（$100/月）适合每天高频用 Codex / 写长文 / 跑分析；Pro 20x（$200/月）面向重度自动化 / Agent 玩家。普通用户先 Plus，撞限额了再升级，不要一开始就买高档位。',
  },
  {
